  ...
  >
    <div v-if="mediumScreenOrAbove" class="absolute w-full h-full">
      <div v-if="timerStarted" class="absolute w-full h-full">
        ...
        <div class="digital-timer-btn sm:mt-4">
    ...
    <div v-if="!mediumScreenOrAbove" class="absolute w-full h-full">
      <div v-if="timerStarted" class="absolute w-full h-full">
        <Transition name="fadeIn" mode="out-in">
          <div v-if="!nextSection" class="first-slide">
          ...
          <div v-else-if="nextSection" class="second-slide">
            <div
              class="second-slide-switch-section"
      ...
      <div v-else-if="!timerStarted" class="absolute w-full h-full">
